...
FOUNDATION_EXPORT NSNotificationName const RaStarShareResultNotificationName;
...
/// @param image （支持UIImage，NSdata以及图片链接Url NSString类对象集合）
- (void)shareWithImage:(id _Nullable)image;
